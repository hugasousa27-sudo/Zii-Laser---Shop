      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <p className="text-sm text-white/95 max-w-sm">
              {t("footerDesc")}
            </p>
            <div className="flex space-x-4 justify-center">
              {/* Facebook Custom SVG */}
              <a href="#" className="hover:text-white/80 text-white transition-colors" aria-label="Facebook">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.8z"/>
                </svg>
              </a>
              {/* Instagram Custom SVG */}
              <a href="#" className="hover:text-white/80 text-white transition-colors" aria-label="Instagram">
              ...
              {/* YouTube Custom SVG */}
              <a href="#" className="hover:text-white/80 text-white transition-colors" aria-label="YouTube">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* TikTok Custom SVG */}
              <a href="#" className="hover:text-white/80 text-white transition-colors" aria-label="TikTok">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <ul className="space-y-3 text-sm flex flex-col items-center">
              <li className="flex items-center space-x-3 justify-center text-white">
                <Phone className="h-4 w-4 text-white flex-shrink-0" />
                <span>+351 210 000 000</span>
              </li>
              <li className="flex items-center space-x-3 justify-center text-white">
                <Mail className="h-4 w-4 text-white flex-shrink-0" />
                <a href="mailto:suporte@ziilaser.com" className="hover:text-white/80 text-white transition-colors">
                  suporte@ziilaser.com
                </a>
              </li>
              <li className="flex items-start space-x-3 justify-center text-white">
                <MapPin className="h-4 w-4 text-white flex-shrink-0 mt-0.5" />
                <span className="max-w-xs">Av. da Liberdade 123, 1250-140 Lisboa, Portugal</span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <ul className="space-y-3 text-sm flex flex-col items-center">
              <li className="flex items-center space-x-2 justify-center text-white">
                <Shield className="h-4 w-4 text-white" />
                <Link href="#" className="hover:text-white/80 text-white transition-colors">
                  {t("footerPrivacy")}
                </Link>
              </li>
              <li className="flex items-center space-x-2 justify-center text-white">
        ...
        {/* Copyright */}
        <div className="flex flex-col items-center justify-center text-center text-xs text-white space-y-2">
