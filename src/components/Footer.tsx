        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              {/* Facebook Custom SVG */}
              <a href="#" className="hover:text-indigo-400 text-slate-400 transition-colors" aria-label="Facebook">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.8z"/>
                </svg>
              </a>
              {/* Instagram Custom SVG */}
              <a href="#" className="hover:text-indigo-400 text-slate-400 transition-colors" aria-label="Instagram">
              ...
              {/* YouTube Custom SVG */}
              <a href="#" className="hover:text-indigo-400 text-slate-400 transition-colors" aria-label="YouTube">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
              ...
              {/* TikTok Custom SVG */}
              <a href="#" className="hover:text-indigo-400 text-slate-400 transition-colors" aria-label="TikTok">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:suporte@vanguard.com" className="hover:text-white transition-colors">
